...
app.get('/api/products',async (req, res) => {
  ...
  { 
    ...
    filter['provider']={ $regex: provider };
  }
  if(child && child!='undefined')
  {
    if(child.charCodeAt(0)>96)
     child=String.fromCharCode(child.charCodeAt(0)-32)+child.substr(1,child.length-1);
    filter['childSub']={ $regex: child };
  }
